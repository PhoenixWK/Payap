...
export default function Heading1Section() {
    return (
        <section className="bg-[#f4fbf2] px-4 lg:px-6 py-6 lg:py-8 rounded-lg">
           <div className="space-y-6 ">
                <h1 className="text-3xl lg:text-5xl dark:text-black text-center font-bold">Integrations</h1>
